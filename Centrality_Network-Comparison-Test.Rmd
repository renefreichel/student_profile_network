...
for (cohort in cohorts) {
  file <- paste0("anonymized_cohort", cohort, ".csv")
...
```{r}
networkCLIN2 <- estimateNetwork(dataClin[,-c(1:2)],
                               default = "pcor",
                               corMethod = "spearman")

networkNotCLIN2 <- estimateNetwork(dataNotClin[,-c(1:2)],
                               default = "pcor",
                               corMethod = "spearman")
```

```{r}
avgLayout2 <- averageLayout(networkCLIN, networkNotCLIN)
